...
description: Colpitts Ocillator Theory and Practical
menu:
  sidebar:
...
Any osillator circuit will generally have a amplifier, positive feedback and frequency determining components

In this article, we will look into a LC Oscillator circuit, namely Colpitts Osillator

## Colpitts Oscillator

A LC Tank circuit in positive feedback is the basic pronciple behind colputs oscillator. It uses capacitve voltage divider as its feedback source. The circuit diagram of Colpitts Oscillator with Op-amp is shown below.

This circuit can be divided into 3 parts:
